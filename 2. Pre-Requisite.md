...
- Save identity of user(s) in Guardian IDM and the external application to give correct identity attributes, accesses, and systems according to the pre-defined rules:

|API Function   |Endpoint  |
|---|---|
|Create Identity   |POST/api/identity/external/save   |

- Add image of the user(s) to the profile in Guardian IDM and external application:

|API Function   |Endpoint  |
|---|---|
|Add Image   |POST/api/identity/external/updateImage   |

- Activate identity of the user(s):
